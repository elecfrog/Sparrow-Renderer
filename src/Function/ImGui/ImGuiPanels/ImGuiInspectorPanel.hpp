...
namespace elf
{
	...
	template<>
	void DrawComponentByType<GameOjbectComponentType::Transform>(GameOjbectComponent & component)
	{
		// Get the Transform component data
		auto& transformData = std::get<ComponentData<GameOjbectComponentType::Transform>>(component.data);

		ImGui::PushID("Tranform");
		if (ImGui::TreeNode("Tranform")) /* Enable Tree View */
		{
			if (ImGui::BeginChild("Tranform", ImVec2(0, 100), true))
			{
	...
	template<>
	void DrawComponentByType<GameOjbectComponentType::Camera>(GameOjbectComponent & component)
	{
		ImGui::PushID("Camera");
	...
	template<>
	void DrawComponentByType<GameOjbectComponentType::Light>(GameOjbectComponent & component)
	{
		// Get the Transform component data
		auto& lgihtData = std::get<ComponentData<GameOjbectComponentType::Light>>(component.data);
	...
	template<>
	void DrawComponentByType<GameOjbectComponentType::Renderer>(GameOjbectComponent & component)
	{
	...
	public:
		...
		void SetSelectedGameObject(const std::shared_ptr<GameObject>& gameObject_ptr)
		{
