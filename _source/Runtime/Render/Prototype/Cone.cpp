...
namespace Sparrow
{
    Cone::Cone(Vector3f tip, Vector3f baseCenter)
    ...
    void Cone::Render(Shader& shader, CameraComponent& camera, glm::mat4& matModel, const Light& light)
    {
        shader.Bind()
              // setup MVP models
    ...
    void Cone::buildMeshFilter(uint32_t N, float r)
    {
        ...
        Vector3f normal = glm::normalize(baseCenter - tip);
