...
namespace Sparrow
{
    struct Plane
    {
        ...
        void Render(const SharedPtr<Shader>& shader, CameraComponent& camera, glm::mat4& model_matrix, const Light& light)
        {
            shader->Bind();
    ...
    private:
        ...
        {
            m_MeshRendererComponent = MeshRendererComponent(m_MeshComponent);
        }
