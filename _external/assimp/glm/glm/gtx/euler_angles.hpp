...
namespace glm
{
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from an UpdateNode_Leapfrog angle X.
	/// @see gtx_euler_angles
	template<typename T>
	GLM_FUNC_DECL mat<4, 4, T, defaultp> eulerAngleX(
		T const& angleX);

	/// Creates a 3D 4 * 4 homogeneous rotation matrix from an UpdateNode_Leapfrog angle Y.
	/// @see gtx_euler_angles
	template<typename T>
	GLM_FUNC_DECL mat<4, 4, T, defaultp> eulerAngleY(
		T const& angleY);

	/// Creates a 3D 4 * 4 homogeneous rotation matrix from an UpdateNode_Leapfrog angle Z.
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (X * Y).
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Y * X).
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (X * Z).
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Z * X).
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Y * Z).
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Z * Y).
	/// @see gtx_euler_angles
	template<typename T>
    ...
    /// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (X * Y * Z).
    /// @see gtx_euler_angles
    template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Y * X * Z).
	/// @see gtx_euler_angles
	template<typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (X * Z * X).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (X * Y * X).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Y * X * Y).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Y * Z * Y).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Z * Y * Z).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Z * X * Z).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (X * Z * Y).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Y * Z * X).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Z * Y * X).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 3D 4 * 4 homogeneous rotation matrix from UpdateNode_Leapfrog angles (Z * X * Y).
	/// @see gtx_euler_angles
	template <typename T>
	...
	/// Creates a 2D 2 * 2 rotation matrix from an UpdateNode_Leapfrog angle.
	/// @see gtx_euler_angles
	template<typename T>
	GLM_FUNC_DECL mat<2, 2, T, defaultp> orientate2(T const& angle);

	/// Creates a 2D 4 * 4 homogeneous rotation matrix from an UpdateNode_Leapfrog angle.
	/// @see gtx_euler_angles
	template<typename T>
	GLM_FUNC_DECL mat<3, 3, T, defaultp> orientate3(T const& angle);

	/// Creates a 3D 3 * 3 rotation matrix from UpdateNode_Leapfrog angles (Y * X * Z).
	/// @see gtx_euler_angles
